$(document).ready(function() {
	$('#group-bi').mouseenter(function() {
		...
		$('.subunit.NIR').css({"fill" : "CCCCCC"});
		$('.subunit.IMN').css({"fill" : "CCCCCC"});

		$('.subunit.GGA').css({"fill" : "FFFFFF"});
		$('.subunit.GGG').css({"fill" : "FFFFFF"});
		$('.subunit.GGS').css({"fill" : "FFFFFF"});
		$('.subunit.JEY').css({"fill" : "FFFFFF"});
		return false;
	});
	...
	$('#island-gbr').mouseenter(function() {
		...
		$('.subunit.GGS').css({"fill" : "CCCCCC"});
		$('.subunit.JEY').css({"fill" : "CCCCCC"});
		return false;
	});
